...
//----------------------------------------------------/
function translate() {
    $.getScript('dist/antler/js/lib/i18next.min.js', function() {
        $.getScript('dist/antler/js/lib/i18nextXHRBackend.min.js', function() {
            $.getScript('dist/antler/js/lib/jquery-i18next.min.js', function() {
                ...
                .init({
                    ...
                    fallbackLng: 'en-US',
                    backend: {
                        loadPath: 'dist/antler/locales/{{lng}}/translations.json'
                    }
                }, function(err, t) {
