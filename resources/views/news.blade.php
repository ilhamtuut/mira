  ...
  <div class="top-header">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="wrapper">
            <div class="heading">MIRA News</div>
            <div class="subheding">The latest news and announcements about our MIRA.</div>
          </div>
        </div>
      </div>
    </div>
                  ...
                  <div class="sec-normal pt-0">
                    <div class="sec-main sec-bg1">
                      <div class="action-content">
                        <img data-src="{{asset('images/news/'.$value->image)}}" class="img-responsive lazyload" alt="photo" >
                      </div>
                      <div class="row text-blog">
                        <div class="col-sm-12 col-md-12 col-lg-6 p-0">
                          <div class="timer">
                            <i class="icon-calendar"></i>
                            <span class="pl-2 pr-4"> {{$value->created_at}}</span>
                          </div>
                        </div>
                        {{-- <div class="col-sm-12 col-md-12 col-lg-6 p-0">
                      ...
                      <div class="heading blog"><a href="{{route('newsDetail',$value->slug)}}">{{$value->title}}</a></div>
                      <div class="blog-info">
